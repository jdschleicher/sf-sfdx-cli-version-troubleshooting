...
$create_scratch_result_json = $(sfdx force:org:create --targetdevhubusername $devhub_alias --definitionfile config/project-scratch-def.json --wait 15 --durationdays 1 -a $scratch_org_alias --json --dev-debug )
