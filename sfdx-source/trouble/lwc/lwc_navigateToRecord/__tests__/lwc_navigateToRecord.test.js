...
import LWC_NavigateToRecord from 'c/lwc_navigateToRecord';
import { getNavigateCalledWith } from 'lightning/navigation';

describe('c-lwc-lwc-navigate-to-record', () => {
    afterEach(() => {
    ...
    it('navigates to record view', () => {
        ...
        const element = createElement('c-lwc-navigate-to-record', {
            is: LWC_NavigateToRecord
        });
